...
-(void)groupAnimation{
    ...
    NSValue *value0 = [NSValue valueWithCGPoint:CGPointMake(0, K_height/2-50)];
    NSValue *value1 = [NSValue valueWithCGPoint:CGPointMake(K_width/3, K_height/2-50)];
    NSValue *value2 = [NSValue valueWithCGPoint:CGPointMake(K_width/3, K_height/2+50)];
    NSValue *value3 = [NSValue valueWithCGPoint:CGPointMake(K_width*2/3, K_height/2+50)];
    NSValue *value4 = [NSValue valueWithCGPoint:CGPointMake(K_width*2/3, K_height/2-50)];
    NSValue *value5 = [NSValue valueWithCGPoint:CGPointMake(K_width, K_height/2-50)];
...
- (void)transitionAnimation_2
{
    ...
    for (int i = 0; i<16; i++) {
        ...
        bt.frame = CGRectMake(10+(i%2)*K_width/2, 25*(i/2)+100, 100, 25);
...
- (UIView *)testView
{
    if (!_testView) {
        ...
        _testView.center = CGPointMake(K_width/2, K_height/2);
...
- (UIImageView *)imageview
{
    if (!_imageview) {
        ...
        _imageview.center = CGPointMake(K_width/2, K_height/2-200);
...
- (UIImageView *)transviewimageview
{
    if (!_transviewimageview) {
        ...
        _transviewimageview.backgroundColor = [UIColor greenColor];
