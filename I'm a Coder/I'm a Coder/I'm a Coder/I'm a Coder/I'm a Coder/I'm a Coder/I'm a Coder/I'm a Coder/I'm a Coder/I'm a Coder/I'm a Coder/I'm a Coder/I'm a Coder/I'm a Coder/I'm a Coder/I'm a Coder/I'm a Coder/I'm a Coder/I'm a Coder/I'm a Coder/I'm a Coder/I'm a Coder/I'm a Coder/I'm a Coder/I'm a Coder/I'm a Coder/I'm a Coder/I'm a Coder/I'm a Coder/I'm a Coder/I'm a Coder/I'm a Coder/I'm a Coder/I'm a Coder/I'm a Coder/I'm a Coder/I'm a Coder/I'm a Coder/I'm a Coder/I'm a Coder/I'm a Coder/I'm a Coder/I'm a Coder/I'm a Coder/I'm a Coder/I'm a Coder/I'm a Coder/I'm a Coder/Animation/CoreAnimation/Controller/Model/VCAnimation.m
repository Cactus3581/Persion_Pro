...
- (instancetype)initWithTransitionType:(animationActionType)type{
    self = [super init];
    if (self) {
        _type = type;
    }
...
{
    switch (_type) {
        case AnimationTransitionTypePresent:
            [self presentAnimation_snap:transitionContext];
            
            break;
        case AnimationTransitionTypeDismiss:
            
            [self dismissAnimation_snap:transitionContext];
            
            break;
        case AnimationTransitionTypePush:
            
            break;
        case AnimationTransitionTypePop:
 ...
 *  实现present动画
 */
- (void)presentAnimation_snap:(id<UIViewControllerContextTransitioning>)transitionContext{
 ...
 *  实现dimiss动画
 */
- (void)dismissAnimation_snap:(id<UIViewControllerContextTransitioning>)transitionContext{
...
// onecate
- (void)onecateAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
