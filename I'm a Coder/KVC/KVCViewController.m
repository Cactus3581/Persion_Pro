...
- (void)viewDidLoad {
    ...
    bt.titleLabel.backgroundColor = [UIColor greenColor];
    bt.imageView.backgroundColor = [UIColor lightGrayColor];
  ...
  */
   ...
   [bt setTitleEdgeInsets:UIEdgeInsetsMake(0, 13, 0, -13)];
    ...
    [bt mas_makeConstraints:^(MASConstraintMaker *make) {
     ...
     //   make.centerX.mas_equalTo(K_width/2);

        make.width.mas_equalTo(100);
        make.height.mas_equalTo(40);
        make.left.mas_equalTo(K_width-100);
    }];
