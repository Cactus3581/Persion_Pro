...
/**
 @brief  ios系统自带扫码功能
 */
@interface KSQRCodeScanTool : NSObject
#pragma mark --初始化
/**
 @brief  初始化采集相机
...
/**
 ...
 @return KScanNative的实例
 */
- (instancetype)initWithPreView:(UIView*)preView ObjectType:(NSArray*)objType cropRect:(CGRect)cropRect //限制扫描区域
                        success:(void(^)(NSArray<KSQRCodeScanResult*> *array))block;
