...
@interface Sub_B_ViewController ()
...
@implementation Sub_B_ViewController
...
- (void)creatshapeLayer_one
{
    ...
    gradientLayer.position =CGPointMake(K_width/2, K_height/2) ;
...
- (void)creatreplicatorLayer
{
    ...
    replicatorLayer.position = CGPointMake(K_width/2, K_height/2-200);
...
- (void)creatreplicatorLayer_two
{
    ...
    replicatorLayer.position = CGPointMake(K_width/2, K_height/2);
...
- (void)creatreplicatorLayer_three
{
    ...
    replicatorLayer.position = CGPointMake(K_width/2, K_height/2+100);
    replicatorLayer.backgroundColor = [UIColor redColor].CGColor;
    [self.view.layer addSublayer:replicatorLayer];
